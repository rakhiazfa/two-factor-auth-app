...
export interface ICustomFirebaseNotificationPayload
...
export const messagingBackgroundMessageHandler = () => {
  messaging().setBackgroundMessageHandler(async _remoteMessage => {
    console.log(
      '->>> messagingBackgroundMessageHandler _remoteMessage',
      _remoteMessage
    )
...
export const messagingOnNotificationOpenedApp = () => {
  messaging().onNotificationOpenedApp(remoteMessage => {
    console.log(
      '->>> messagingOnNotificationOpenedApp remoteMessage',
      remoteMessage
    )
  })
}
...
export const messagingGetInitialNotification = async () => {
  ...
  console.log(
    '->>> messagingGetInitialNotification remoteMessage',
    remoteMessage
  )
}
